...
const TrackingDetails = () => {
  ...
  const loadTrackingDetails = async () => {
    ...
    try {
      const trackingData =
        await trackingService.getTrackingByTrackingId(trackingId);
      ...
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-4">
            The requested tracking number could not be found.
          </p>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          {hasPermission("tracking", "write") && (
            <Button onClick={() => setShowUpdateModal(true)} size="sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span
                className={`inline-flex px-2 py-1 text-sm font-semibold rounded-full ${getStatusColor(tracking.status)}`}
              >
          ...
          <div>
            ...
            <span
              className={`inline-flex px-2 py-1 text-sm font-semibold rounded-full ${getPriorityColor(tracking.priority)}`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div>
            ...
            <div className="text-sm text-gray-900">
              ...
              <p>
                {tracking.sender.address.city}, {tracking.sender.address.state}{" "}
                {tracking.sender.address.postalCode}
              </p>
          ...
          <div>
            ...
            <div className="text-sm text-gray-900">
              ...
              <p>
                {tracking.recipient.address.city},{" "}
                {tracking.recipient.address.state}{" "}
                {tracking.recipient.address.postalCode}
              </p>
